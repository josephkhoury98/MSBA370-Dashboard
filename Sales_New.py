...
#------------------------------ Data collection ---------------------------------
sales = pd.read_csv('https://raw.githubusercontent.com/josephkhoury98/MSBA370-Dashboard/main/SALES_SALES.csv',error_bad_lines=False)
#sales = sales.rename({'Sales Category': 'Sales Category'}, axis=1)
sales.info()
rent = pd.read_csv('https://raw.githubusercontent.com/josephkhoury98/MSBA370-Dashboard/main/RENT_RENT.csv', error_bad_lines=False)
...
Rent_input = col1.text_input("Rent", "Type here")
